...
%% Векторные (Type 1) шрифты вместо растровых — документ выглядит чётче.
%% Шрифты cm-super должны быть установлены в систему (tlmgr install cm-super);
%% при активной кодировке T2A они подключаются автоматически. lmodern даёт
%% векторную Unicode-реализацию Computer Modern (аналог cm-unicode).
\usepackage{lmodern}
...
%% Интервалы (полуторный межстрочный интервал по требованиям к ВКР)
\usepackage{setspace}
\onehalfspacing

%% Оформление заголовков: 14 пт, по центру (главы и параграфы)
\usepackage{titlesec}
\titleformat{\section}
  {\normalfont\fontsize{14}{17}\bfseries\centering}{\thesection}{0.5em}{}
\titleformat{\subsection}
  {\normalfont\fontsize{14}{17}\bfseries\centering}{\thesubsection}{0.5em}{}
...
%% Глубина нумерации и содержания
\setcounter{secnumdepth}{3}
\setcounter{tocdepth}{2}

%% TikZ
\usepackage{tikz}
\usetikzlibrary{graphs,graphs.standard,arrows.meta,positioning,fit,backgrounds,calc}

%% Графики (анализ слоёв, кривые обучения)
\usepackage{pgfplots}
